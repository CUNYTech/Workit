...
public class ListViewActivityBiceps extends AppCompatActivity implements ExerciseDialog.ExerciseDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] default_exercise_shoulders={"Barbell Curl","Incline Dumbbell Curl","Standing Biceps Cable Curl",
                "Reverse-Grip Bent-Over Row","Concentration Curl"};
        ...
        listvw.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Toast.makeText(ListViewActivityBiceps.this, exercise, Toast.LENGTH_SHORT).show();
            }
        });
