...
public class ListViewActivityTriceps extends AppCompatActivity implements ExerciseDialog.ExerciseDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] default_exercise_shoulders={"CLOSE-GRIP BENCH PRESS", "WEIGHTED PARALLEL-BAR DIP", "WEIGHTED BENCH DIP", "TRICEPS DIP MACHINE",
        "BOARD PRESS"};
        ...
        listvw.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Toast.makeText(ListViewActivityTriceps.this, exercise, Toast.LENGTH_SHORT).show();
            }
        });
